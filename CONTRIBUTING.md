Contributing to YieldStakingWallet Core
============================

The YieldStakingWallet Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to yieldstakingwallet-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the yieldstakingwallet unit tests or QA tests
...
[Translation Process](https://github.com/yieldstakingwallet-project/yieldstakingwallet/blob/master/doc/translation_process.md)
...
The following applies to code changes to the YieldStakingWallet Core project, and is not to be
confused with overall YieldStakingWallet Network Protocol consensus changes.

Whether a pull request is merged into YieldStakingWallet Core rests with the project merge
...
Patches that change YieldStakingWallet consensus rules are considerably more involved than
...
Where a patchset proposes to change the YieldStakingWallet consensus, it must have been
...
The project leader is the release manager for each YieldStakingWallet Core release.
