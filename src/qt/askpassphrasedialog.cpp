...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            YieldSakingWalletGUI* window = static_cast<YieldSakingWalletGUI*>(parentWidget());
...
{
    YieldSakingWalletGUI* gui = static_cast<YieldSakingWalletGUI*>(parentWidget());
...
{
    hide();
    static_cast<YieldSakingWalletGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("YieldStakingWallet will close now to finish the encryption process. "
