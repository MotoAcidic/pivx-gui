...
#include "qt/yieldstakingwallet/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/yieldstakingwallet/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(YieldSakingWalletGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableYSW,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableYSW,
    ...
    connect(ui->pushButton_UnspendableYSW, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableYSW);});
    ...
    if (parent)
        connect(parent, &YieldSakingWalletGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
