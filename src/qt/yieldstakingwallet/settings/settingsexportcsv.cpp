...
#include "qt/yieldstakingwallet/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(YieldSakingWalletGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("YieldSakingWallet_tx_csv_export(*.csv)") : tr("YieldSakingWallet_addresses_csv_export(*.csv)"),
                                        nullptr);
