...
#include "qt/yieldstakingwallet/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/yieldstakingwallet/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(YieldSakingWalletGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to YieldSakingWalletGUI::handleRestart()
