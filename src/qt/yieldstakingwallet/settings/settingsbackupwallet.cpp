...
#include "qt/yieldstakingwallet/settings/forms/ui_settingsbackupwallet.h"
...
SettingsBackupWallet::SettingsBackupWallet(YieldSakingWalletGUI* _window, QWidget *parent) :
