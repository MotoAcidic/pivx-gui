...
#include "qt/yieldstakingwallet/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(YieldSakingWalletGUI* _window, QWidget *parent) :
