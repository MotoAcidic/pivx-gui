...
#include "qt/yieldstakingwallet/settings/settingsnetworkwidget.h"
#include "qt/yieldstakingwallet/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/yieldstakingwallet/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(YieldSakingWalletGUI* _window, QWidget *parent) :
