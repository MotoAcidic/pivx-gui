...
#include "qt/yieldstakingwallet/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/yieldstakingwallet/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(YieldSakingWalletGUI* _window, QWidget *parent) :
