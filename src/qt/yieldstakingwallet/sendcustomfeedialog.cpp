...
#include "qt/yieldstakingwallet/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(YieldSakingWalletGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &YieldSakingWalletGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
