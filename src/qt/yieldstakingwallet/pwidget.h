...
#include <QWidget>
#include <QString>
#include "qt/yieldstakingwallet/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(YieldSakingWalletGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    YieldSakingWalletGUI* getWindow() { return this->window; }
...
protected:
    YieldSakingWalletGUI* window = nullptr;
