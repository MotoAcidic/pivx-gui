...
#include "qt/yieldstakingwallet/forms/ui_receivewidget.h"
...
#include "qt/yieldstakingwallet/myaddressrow.h"
...
ReceiveWidget::ReceiveWidget(YieldSakingWalletGUI* parent) :
    PWidget(parent),
