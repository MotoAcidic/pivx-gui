...
#ifndef YieldSakingWallet_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define YieldSakingWallet_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //YieldSakingWallet_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
