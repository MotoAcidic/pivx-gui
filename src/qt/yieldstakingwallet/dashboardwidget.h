...
#include "qt/yieldstakingwallet/furlistrow.h"
...
#include "config/yieldstakingwallet-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalYsw = 0;
    qint64 totalZysw = 0;
    QList<qreal> valuesYsw;
    QList<qreal> valueszYsw;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(YieldSakingWalletGUI* _window);
    ~DashboardWidget();
