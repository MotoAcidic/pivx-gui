...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, YieldSakingWalletGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, YieldSakingWalletGUI* gui, double posX = 3);
