...
#include "qt/yieldstakingwallet/topbar.h"
#include "qt/yieldstakingwallet/forms/ui_topbar.h"
#include "qt/yieldstakingwallet/lockunlock.h"
#include "qt/yieldstakingwallet/qtutils.h"
#include "qt/yieldstakingwallet/receivedialog.h"
#include "qt/yieldstakingwallet/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/yieldstakingwallet/balancebubble.h"
...
TopBar::TopBar(YieldSakingWalletGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopYsw, ui->labelAmountTopShieldedYsw}, "amount-small-topbar");
    setCssProperty({ui->labelAmountYsw}, "amount-topbar");
    setCssProperty({ui->labelPendingYsw, ui->labelImmatureYsw}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("YieldStakingWallet")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // YSW Total
    QString totalYsw = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // YSW
    // Top
    ui->labelAmountTopYsw->setText(totalTransparent);
    ui->labelAmountTopShieldedYsw->setText(totalShielded);
    // Expanded
    ui->labelAmountYsw->setText(totalYsw);
    ui->labelPendingYsw->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureYsw->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
