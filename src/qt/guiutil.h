...
/** Utility functions used by the YieldStakingWallet Qt UI.
 */
namespace GUIUtil
{
...
// Render YieldStakingWallet addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZysw = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZysw = false);
...
// Parse "yieldstakingwallet:" URI into recipient object, return true on successful parsing
