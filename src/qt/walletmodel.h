...
#ifndef YieldSakingWallet_QT_WALLETMODEL_H
#define YieldSakingWallet_QT_WALLETMODEL_H
...
/** Interface to YieldStakingWallet wallet from Qt view code. */
...
#endif // YieldSakingWallet_QT_WALLETMODEL_H
