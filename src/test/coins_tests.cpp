    ...
    for (unsigned int i = 0; i < NUM_SIMULATION_ITERATIONS; i++) {
        ...
        if (randiter % 20 < 19) {
            ...
            if (randiter % 20 < 2 || coinbase_coins.size() < 10) {
                // YieldStakingWallet: don't test for duplicate coinbases as those are not possible due to
            ...
            // 17/20 times reconnect previous or add a regular tx
                ...
                if (randiter % 20 == 2 && disconnected_coins.size()) {
                    ...
                    // YieldStakingWallet: no duplicates
...
BOOST_AUTO_TEST_CASE(ccoins_serialization)
{
    ...
    // YieldStakingWallet: Example with fCoinStake
...
BOOST_AUTO_TEST_CASE(ccoins_add)
{
     ...
     *
     * YieldStakingWallet: Remove Coinbase argument (ref: https://github.com/YieldStakingWallet-Project/YieldStakingWallet/pull/1775)
     *
