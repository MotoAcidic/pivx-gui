...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"yieldsakingwalletaddress\"\n"
            "\nReturn information about the given yieldstakingwallet address.\n"

            "\nArguments:\n"
            "1. \"yieldsakingwalletaddress\"     (string, required) The yieldstakingwallet address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"yieldsakingwalletaddress\",    (string) The yieldstakingwallet address validated\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"yieldsakingwalletaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"yieldsakingwalletaddress\"  (string, required) The yieldstakingwallet address to use for the signature.\n"
