...
extern const char * const YieldSakingWallet_CONF_FILENAME;
extern const char * const YieldSakingWallet_PID_FILENAME;
extern const char * const YieldSakingWallet_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("yieldstakingwallet-%s", name);
