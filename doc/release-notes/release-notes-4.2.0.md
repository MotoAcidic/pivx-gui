...
```
src/bench/bench_yieldsakingwallet
```
...
be used in v4.2 by starting yieldsakingwalletd with the '-deprecatedrpc=accounts'
...
### Build System
 - #1681 `131ec069fd` [Build] Set complete cpp/cxx flags for bench_yieldsakingwallet binary (Fuzzbawls)
