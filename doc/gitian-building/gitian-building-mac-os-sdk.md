...
The script [extract-osx-sdk.sh](https://github.com/yieldstakingwallet-project/yieldstakingwallet/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
yieldstakingwallet/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/yieldstakingwallet-project/yieldstakingwallet/blob/master/doc/README_osx.md) for troubleshooting tips.