...
The build script we'll be using is contained in the YieldStakingWallet github repository ([contrib/gitian-build.py](https://github.com/yieldstakingwallet-project/yieldstakingwallet/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the YieldStakingWallet repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/YieldStakingWallet-Project/YieldStakingWallet/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, yieldstakingwallet-detached-sigs, and yieldstakingwallet GitHub repos.
