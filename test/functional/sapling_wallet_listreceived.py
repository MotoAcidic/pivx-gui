...
class ListReceivedTest (YieldSakingWalletTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 YSW.
        ...
        # Send 1 YSW to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 YSW sending them all (fee is 0.1 YSW)
        ...
        # Confirm transaction (2 YSW from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 YSW, send 0.6 YSW + 0.05 YSW fee
