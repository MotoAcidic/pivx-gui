...
from test_framework.yieldstakingwallet_node import YieldSakingWalletTestNode
...
class YieldSakingWallet_ColdStakingTest(YieldSakingWalletTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(YieldSakingWalletTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 YSW from the pot)
...
if __name__ == '__main__':
    YieldSakingWallet_ColdStakingTest().main()
