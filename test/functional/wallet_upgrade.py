...
- 1) start one yieldstakingwalletd node from an pre-HD wallet wallet.dat file localized in util/data
...
class WalletUpgradeTest (YieldSakingWalletTestFramework):
