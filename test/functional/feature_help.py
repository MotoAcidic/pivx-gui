...
"""Verify that starting yieldstakingwallet with -h works as expected."""
import subprocess

from test_framework.test_framework import YieldSakingWalletTestFramework
from test_framework.util import assert_equal

class HelpTest(YieldSakingWalletTestFramework):
    ...
    def run_test(self):
        self.log.info("Start yieldstakingwallet with -? for help text")
        ...
        self.log.info("Start yieldstakingwallet with -version for version information")
