...
from test_framework.test_framework import YieldSakingWalletTier2TestFramework
...
class MasternodeGovernanceBasicTest(YieldSakingWalletTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.yieldstakingwallet.org/t/test-proposal"
