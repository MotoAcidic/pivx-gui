...
class TxnMallTest(YieldSakingWalletTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 6,250 YSW:
        ...
        # First: use raw transaction API to send 1240 * 5 YSW to node1_address,
        # but don't broadcast:
